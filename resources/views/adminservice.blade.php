                        ...
                        <div class="graph-form">
                            <div class="form-body">
                                <form method="post" action="addservices">
                                    ...
                                    <div class="form-group"> <label for="exampleInputEmail1">Price of Service</label> <input type="text" name="sprice" placeholder="Price of Service" value="" class="form-control" required='true'> </div>
