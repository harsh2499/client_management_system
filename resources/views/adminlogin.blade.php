            ...
            <div class="error-top">
                ...
                <div class="login">
                    ...
                    <form method="post" action="login"> 
                        @csrf
                        <input type="text" class="text" name="username" required="true" placeholder="Enter The Username">
                        <input type="password"   name="password" required="true" placeholder="Enter The Password">
