...
<head>
    ...
    <!-- Custom Theme files -->
    <link href="wel/css/bootstrap.min.css" type="text/css" rel="stylesheet" media="all">
    <link href="wel/css/style.css" type="text/css" rel="stylesheet" media="all">
    <!-- font-awesome icons -->
    <link href="wel/css/font-awesome.min.css" rel="stylesheet">
    <!-- //Custom Theme files -->
    <!-- online-fonts -->
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-lg-2" id="spy">
                ...
                <button type="button" class="btn btn-block mt-lg-5 mt-3 w3ls-btn p-1 btn-theme text-white  text-uppercase font-weight-bold" 
                    >
                    <a class="nav-link" href="clientlogin">Client</a>
                </button>
                </ul>
