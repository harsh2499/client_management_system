									 ...
									 <th>Setting</th>
									  ...
									  <tr class="active">
									      <th scope="row">{{$print->ID}}</th>
									       <td>{{$print->AccountID}}</td>
									        <td>{{$print->AccountType}}</td>
									         <td>{{$print->ContactName}}</td> 
									         <td>{{$print->CompanyName}}</td>
									         <td>{{$print->Workphnumber}}</td>
									        <td><a href="/edit/{{$print->ID}}">Edit</a>  ||  <a href="/add-client-services/{{$print->ID}}">Assign Services</a></td>
									     </tr>
									     @endforeach
									     									     </tbody> </table> 
							</div>
